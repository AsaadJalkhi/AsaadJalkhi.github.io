/** Small shared helpers. Nothing app-specific belongs here. */
...
/** Stable 32-bit hash — drives deterministic generated artwork from an id. */
...
/** Seeded pseudo-random sequence so generated posters never flicker. */
